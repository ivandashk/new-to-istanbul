...
<div class="relative overflow-hidden bg-white">
	<div class="mx-auto max-w-7xl">
		...
		>
							...
							<div class="flex w-full items-center justify-between md:w-auto">
								...
								<div class="-mr-2 flex items-center md:hidden">
									<button
										...
										aria-expanded={isBurgerMenuOpened}
          ...
          -->
				<div
					class:hidden={!isBurgerMenuOpened}
			...
			>
				<div class="sm:text-center lg:text-left">
					<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
						<span class="block xl:inline">Итак, вы в</span>
						<span class="block text-orange-600 xl:inline"> Стамбуле</span>
					</h1>
					<p
						class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0"
					>
						Мы собрали для вас пошаговое руководство как быстро освоиться в городе и начать
